...
[`r icons::icon_style(icons::fontawesome(name = "link", style = "solid"), fill = "#23373b", scale = 1.7)`](https://mauriciovancine.github.io)
[`r icons::icon_style(icons::academicons("cv"), fill = "#23373b", scale = 2)`](https://mauriciovancine.github.io/pt/cv/cv-mauricio-vancine-pt-academic-complete.html)
[`r icons::icon_style(icons::fontawesome("twitter"), fill = "#23373b", scale = 2)`](https://twitter.com/mauriciovancine)
[`r icons::icon_style(icons::fontawesome(name = "github"), fill = "#23373b", scale = 2)`](https://github.com/mauriciovancine)
[`r icons::icon_style(icons::academicons("orcid"), fill = "#23373b", scale = 2)`](https://orcid.org/0000-0001-9650-7575)
[`r icons::icon_style(icons::academicons("publons"), fill = "#23373b", scale = 2)`](https://publons.com/researcher/1391845/mauricio-vancine)
[`r icons::icon_style(icons::academicons("lattes"), fill = "#23373b", scale = 2)`](http://lattes.cnpq.br/9761288418931193)
[`r icons::icon_style(icons::academicons("google-scholar"), fill = "#23373b", scale = 2)`](https://scholar.google.com/citations?user=i-2xZBQAAAAJ)
[`r icons::icon_style(icons::fontawesome("linkedin"), fill = "#23373b", scale = 2)`](https://www.linkedin.com/in/mauricio-vancine/)
...
- Podemos associar a taxa de crescimento intrínsica com as condições ambientais favoráveis no Espaço Ambiental (E)
- Essas condições favoráveis no Espaço Ambiental (E) possuem diferentes localizações no Espaço Geográfico (G)
- Modelo vai estimar o nicho ecológico no Espaço Ambiental (E)
...
## Condições ambientais para as ocorrências e para toda a área modelada
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
[Mateo et al. (2012)](https://dx.plos.org/10.1371/journal.pone.0032586),
...
background-position: 10% 60%, 63% 60%, 97% 2%, 98% 65%
...
background-position: 90% 10%, 90% 85%
...
background-image: url(img/sdm_geral.png), url(img/sdm_geral_dados.png)
background-size: 300px, 700px
background-position: 10% 55%, 88% 50%
...
background-image: url(img/sdm_geral.png), url(img/sdm_geral_ajuste.png), url(img/sdm_ribeiro_diniz_avaliacao.png)
background-size: 300px, 600px
background-position: 10% 55%, 80% 55%
...
background-image: url(img/sdm_projecao_tempo.jpg)
background-size: 800px
background-position: 50% 60%
