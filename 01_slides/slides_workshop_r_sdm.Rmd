...
1. Presenças, ausências e pseudo-ausências
1. Somente-presença (BIOCLIM, DOMAIN e Mahalanobis)
1. Presença-background (MaxEnt)
1. Presença-ausência estatístico (GLM e GAM)
1. Presença-ausência aprendizado de máquina (Random Forest e SVM)
...
background-position: 23% 70%, 56% 70%, 93% 80%
...
**Museu Nacional (RJ) em chamas no dia 02/09/2018**

[Foto: Ricardo Moraes/Reuters](https://g1.globo.com/pop-arte/noticia/2018/09/03/principais-museus-do-mundo-utilizam-patrocinio-privado-para-manter-estrutura-e-expandir-acervo-veja-lista.ghtml)
...
background-image: url(img/sdm_tipos_metodos.png)
background-size: 900px
background-position: 50% 85%

# 5.1 Tipos de métodos ou algoritmos

## Dependente dos dados de entrada sobre as espécies
...
# 5.4 Presença-ausência (estatístico)
...
# 5.5 Presença-ausência (aprendizado de máquina)
